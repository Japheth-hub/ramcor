...
function Login() {
    ...
    <form id="formulario-login" action="loginRegistro.php" method="POST">
        <label><input id="name" type="text" name="user" placeholder="Usuario" required></label>
        <label><input id="password" type="password" name="password" placeholder="*********" required></label>
	...
	formulario.addEventListener("submit" , (e) => {
		...
		// 		console.log(datos)
		// 		if(datos == "Bienvenido"){
				if(name.value == "angel" && password.value == "password"){
					formulario.remove();
